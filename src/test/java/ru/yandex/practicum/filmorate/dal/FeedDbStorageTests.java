...
import ru.yandex.practicum.filmorate.storage.dbstorage.mappers.FeedRowMapper;
...
@Import({FeedDbStorage.class, FeedRowMapper.class, UserDbStorage.class, UserRowMapper.class})
